...
-- Module  Version: 5.7
--/opt/diamond/3.9_x64/ispfpga/bin/lin64/scuba -w -n pll -lang vhdl -synth lse -arch xo2c00 -type pll -fin 12 -fclkop 24 -fclkop_tol 0.0 -fclkos 64 -fclkos_tol 0.0 -fclkos2 8 -fclkos2_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phases2 0 -phase_cntl STATIC -fb_mode 1 
...
architecture Structure of pll is
    ...
    attribute FREQUENCY_PIN_CLKOS2 of PLLInst_0 : label is "8.000000";
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "64.000000";
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "24.000000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS2_FPHASE=>  0, CLKOS2_CPHASE=>  71, CLKOS_FPHASE=>  0, 
        CLKOS_CPHASE=>  8, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  23, 
        ...
        CLKOP_ENABLE=> "ENABLED", CLKOS3_DIV=>  1, CLKOS2_DIV=>  72, 
        CLKOS_DIV=>  9, CLKOP_DIV=>  24, CLKFB_DIV=>  2, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
